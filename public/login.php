  ...
  <form id="loginForm" class="auth-form">
    ...
    <div class="social-row">
      ...
      <a href="#" class="social-btn" title="Continue with Facebook">
        <svg viewBox="0 0 24 24"><circle cx="12" cy="12" r="12" fill="#1877F2"/><path d="M16.5 8H14c-.3 0-.5.2-.5.5V10h3l-.4 2.5H13.5V19h-3v-6.5H9V10h1.5V8.5C10.5 6.6 11.8 5 14 5h2.5v3z" fill="#fff"/></svg>
      </a>
